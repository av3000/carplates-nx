...
export class DynamicModalService {
  newModalComponent!: ComponentRef<FrontendAngularSharedUiModalComponent>;
  ...
  private openWithTemplate(
    ...
    this.newModalComponent = vcr.createComponent(
      FrontendAngularSharedUiModalComponent,
      {
  ...
  private openWithComponent(component: Type<unknown>) {
    ...
    this.newModalComponent = createComponent(
      FrontendAngularSharedUiModalComponent,
      {
        environmentInjector: this.injector,
